...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","16","dimension",["macro",19]]],
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003Ewindow._fbq=window._fbq||[];_fbq.push([\"track\",\"Purchase\",{content_ids:",["escape",["macro",35],8,16],",content_type:\"product\",order_id:",["escape",["macro",36],8,16],",value:",["escape",["macro",2],8,16],",currency:\"USD\"}]);\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "function":"__html",
      "setup_tags":["list",["tag",128,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Eire(\"trackConversion\",12148,{orderId:",["escape",["macro",40],8,16],",customerId:",["escape",["macro",41],8,16],",email:",["escape",["macro",42],8,16],",orderPromoCode:",["escape",["macro",43],8,16],",currencyCode:\"USD\",items:[{subTotal:",["escape",["macro",44],8,16],",category:",["escape",["macro",45],8,16],",sku:",["escape",["macro",46],8,16],",quantity:1}]});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":170
      ...
      "setup_tags":["list",["tag",128,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Eire(\"identify\",{customerId:",["escape",["macro",41],8,16],",customerEmail:",["escape",["macro",42],8,16],"});\u003C\/script\u003E\n"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":172
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",2,3,0,118,135]],
    [["if",3,5,6],["add",4,5,8,96,97,98,103,104]],
    [["if",3,7],["add",6,12,13,15,28,40,92,110,111,112,130]],
    [["if",8,9],["add",6,15,31,43,45,46,92,108,113,124,136,138,139,148]],
    [["if",3,10],["add",7,101,102]],
    [["if",0,3,6],["add",9,26,29,38,42,117,126,133,140,141,143,144]],
    [["if",6,11],["add",10,11]],
    [["if",3,4],["add",14],["block",2,3,9,16,23,26,29,38,42,93,1,109,0,117,121,123,126,128,129,133,135,146,153]],
    [["if",3],["add",14,16,36,109,121,146,152,50,51,52,53,54,78,79,80,81,82,83,84,86,87,88,89,90]],
    [["if",12],["add",17,18,48]],
    [["if",13,14,15,16],["add",19]],
    [["if",13,15,16],["unless",14],["add",20]],
    [["if",3,17],["add",21]],
    [["if",3,19],["unless",18],["add",22,44,118]],
    [["if",20,21],["add",23]],
    [["if",16,22,23],["add",24,115]],
    [["if",11],["add",25,30,35,37]],
    [["if",6,8,9],["add",27,41,116,125,131,132,142],["block",143,144]],
    [["if",3,24],["add",28]],
    [["if",3,26],["add",32,120]],
    [["if",16,27,28],["add",33]],
    [["if",16,29],["add",34]],
    [["if",16,30,31],["add",39,122]],
    [["if",3,32],["add",44,118]],
    [["if",3,33],["add",44]],
    [["if",3,34],["add",44,118],["block",128,129]],
    [["if",3,32,35],["add",44,118]],
    [["if",3,36],["add",44,118]],
    [["if",3,37],["add",44,118]],
    [["if",3,38],["add",44,118]],
    [["if",3,39],["add",44,118]],
    [["if",3,40],["add",44]],
    [["if",3,41],["add",47,118,118]],
    [["if",3,42],["add",49,134]],
    [["if",3],["unless",18],["add",55,58,59,62,64,66,69,71,73,74,75,77]],
    [["if",3,43],["add",56,57,60,61,63,65,67,68,70,72,76]],
    [["if",3,44],["add",85]],
    [["if",3,45],["add",91]],
    [["if",3,46],["add",93],["block",127,128,129,146,154]],
    [["if",3,47],["unless",48],["add",93]],
    [["if",49,50],["add",93]],
    [["if",3,52],["add",1]],
    [["if",3,54],["add",94,95]],
    [["if",55],["add",99]],
    [["if",55,56],["add",100,123],["block",117]],
    [["if",55,57],["add",105]],
    [["if",3,58],["add",106]],
    [["if",55,59,60],["add",106]],
    [["if",16,61],["add",107,147]],
    [["if",3,5],["add",114]],
    [["if",3,62],["add",118]],
    [["if",3,63],["add",118]],
    [["if",3,64],["add",118],["block",128,129]],
    [["if",3,65],["add",118]],
    [["if",3,66],["add",118]],
    [["if",3],["unless",67],["add",118]],
    [["if",3,68],["add",118]],
    [["if",3,69],["add",118]],
    [["if",3,70],["add",118]],
    [["if",3,71],["add",118]],
    [["if",3,72],["add",118]],
    [["if",0,2,3],["unless",1],["add",118]],
    [["if",3,73],["unless",74,75],["add",118]],
    [["if",3,76],["add",118]],
    [["if",8,77],["add",119,145]],
    [["if",78,79,80,81],["add",127,137]],
    [["if",0,3],["unless",1,25],["add",128,129,153]],
    [["if",16,86],["add",149]],
    [["if",16,87],["add",150]],
    [["if",16,88],["add",151]],
    [["if",79,81,89],["add",154]],
    [["if",3,25],["block",29,93,1]],
    [["if",3,51],["block",93]],
    [["if",3,53],["block",1]],
    [["if",3,82],["block",127,128,129,146,154]],
    [["if",3,83],["block",127,128,129,146,154]],
    [["if",3,84],["block",127,128,129,146,154]],
    [["if",3,85],["block",128,129]]]
},
"runtime":[
[],[]
]
